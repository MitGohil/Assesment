...
function booking() {
    ...
    if (booking_choice.value == 2 && slot1.value == 0) {
        slot_error.innerHTML = "Please choose your slot"
        time_error.innerHTML = ""
        event.preventDefault()
    }
    else if (booking_choice.value == 3 && slot1.value == 0) {
        slot_error.innerHTML = "Please choose your slot"
        event.preventDefault()
    }
    else {
    ...
    if (isNaN(mo.value)) {
        mo_error.innerHTML = "Please enter only Numeric value in Mobile number"
        event.preventDefault()
    }
